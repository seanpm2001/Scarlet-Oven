...
Gem::Specification.new do |gem|
  gem.name          = 'Scarlet Oven for RaspbianOS (legacy)' # Not to be confused with the modern Raspberry Pi OS version
...
# File version: 1 (2022, Saturday, April 30th at 6:13 pm PST)
